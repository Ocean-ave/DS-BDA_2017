...
docker exec hadoop-master python3 /opt/log_generator.py /opt/data1.log 1 || exit $?
docker exec hadoop-master python3 /opt/log_generator.py /opt/data2.log 2 || exit $?
docker exec hadoop-master python3 /opt/log_generator.py /opt/data3.log 3 || exit $?
docker exec hadoop-master python3 /opt/log_generator.py /opt/data4.log 4 || exit $?
docker exec hadoop-master python3 /opt/log_generator.py /opt/data5.log 5 || exit $?
