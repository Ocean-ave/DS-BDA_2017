...
class Test extends FlatSpec {
  ...
  "The IPMapper" should "return bytes" in {
    ...
    suiteMapDriver.withOutput(new Text("178.7.31.65"), new DualParam(1, 10100))
  ...
  "The IPCombiner" should "return requests count and bytes count" in {
    ...
    suiteCombineDriver.withInput(
      ...
      List(new DualParam(3, 10100), new DualParam(5, 4000)).asJava
    )
    suiteCombineDriver.withOutput(new Text("178.7.31.65"), new DualParam(8, 14100))
  ...
  "The IPReducer" should "return average bytes and total bytes as text" in {
    ...
    suiteReduceDriver.withInput(
      new Text("178.7.31.65"),
      List(new DualParam(3, 10100), new DualParam(2, 4000)).asJava
    )
